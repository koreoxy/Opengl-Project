...
#include <GL/gl.h>
#include <stdlib.h>
#define SPEED 30.0//SPEED ATAU KECEPATAN ANIMASI


//TIPE DATA UNTUK GLOBAL 
...
//function untuk memanggil glut string, untuk membuat tulisan
...
void gambar_object(){
	...
	//PERULANGAN FOR UNTUK MENGAMBAR DAUN POHON
	for(l=0;l<=40;l++)
	{
...
int main(int argc,char** argv){
	...
	glutInitWindowSize(1100.0,700.0); //UKURAN ATAU RESOLUSI WINDOW SCREEN 1100 X 700
	glutInitWindowPosition(0,0);
	glutCreateWindow("Simple Animate"); //JUDUL WINDOW
